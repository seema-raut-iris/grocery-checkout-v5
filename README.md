...
## Overview
Production-ready Spring Boot based Grocery Checkout application designed with **SOLID** design Principle, **Strategy pattern** for promotions, **Actuator**,  and documentation (ER + UML diagrams). Built to compile cleanly with Lombok.
...
3) Discount Assumptions (Promotions)
   Strategy model
